  ...
  <div class="center-view">
    <div class="avatar" data-enter-time="1608645908" data-click-fun="track_f_737069">
      <img
        ...
        class="avator-icon"
      />
      <div class="nick-name" @click="login" v-if="!phone">立即登录</div>
      <div class="nick-name"  v-if="phone">{{phone}}</div>
    </div>
    ...
    <!---->
    <div class="margin-set my-card" data-enter-time="1608645908" data-click-fun="track_f_299313">
      <img
    ...
    <div class="margin-set my-card" data-enter-time="1608645908" data-click-fun="track_f_433177">
      <img
    ...
    <div class="margin-set my-balance" data-enter-time="1608645908" data-click-fun="track_f_475218">
      <img
        ...
        alt
      />
      <span class="label" @click="fun2">余额</span>
      <span class="value">
    ...
    <div class="margin-set system-set" data-enter-time="1608645908" data-click-fun="track_f_628036">
      <img
...
export default {
  ...
  created(){
      ...
      if( this.$store.state.token!== ''){
          this.$http.post('/v1/getUser').then(ret=>{
